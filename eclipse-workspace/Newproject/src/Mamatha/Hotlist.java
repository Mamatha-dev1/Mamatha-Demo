...
Thread.sleep(5000);
        ...
        try {
            ...
            System.out.println("Start value entered successfully");
        } catch (Exception e) {
        ...
        File destDir = new File("C:\\Users\\mamatha.kp\\OneDrive - Subex Limited\\Documents\\Automation ss\\Hotlist.png");
        ...
        try {
            ...
            destDir = new File("C:\\Users\\mamatha.kp\\OneDrive - Subex Limited\\Documents\\Automation ss\\Hotlist.png");
            FileUtils.copyFile(src, destDir);
        ...
        try {
            ...
            Thread.sleep(5000);
            src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
            destDir = new File("C:\\Users\\mamatha.kp\\OneDrive - Subex Limited\\Documents\\Automation ss\\Hotlist_Edited.png");
            FileUtils.copyFile(src, destDir);
