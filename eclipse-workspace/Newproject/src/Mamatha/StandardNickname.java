...
public class StandardNickname {
    ...
    // This method will initialize the driver and WebDriverWait before each test
    @Test
    public void NicknamePage() throws InterruptedException, IOException, TimeoutException {
        ...
        executeNickNamecreation(loginManager.getDriver());
        System.out.println("Standard Nickname creation,Edit and deletion test cases executed successfully");
    }
    
    public void executeNickNamecreation(WebDriver driver) throws InterruptedException, IOException, TimeoutException {
        ...
        try {
            ...
            WebElement StandardnicknameLink = wait.until(ExpectedConditions.elementToBeClickable(By.id("id-Nicknames Standard")));
            StandardnicknameLink.click();
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("yes"))).click();
            System.out.println("Navigating to Standard Nicknames Page.");
        } catch (Exception e) {
            System.out.println("Navigation to Standard Nicknames got failed");
        }
        ...
        try {
            ...
            newUserAction.click();
            System.out.println("Navigating to Standard nickname creation Page.");
        } catch (Exception e) {
            System.out.println("Navigation to Standard nickname creation got failed");
        }

        try {
            // Enter username
            String Nickname = "";
            System.out.println("Please enter the Standard nickname:");
            Scanner scanner = new Scanner(System.in);
            Nickname = scanner.nextLine();
            
            // Find the username input element and enter the username
            WebElement userInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("flicName")));
            // Clear any pre-existing text
            userInput.sendKeys(Nickname);
            System.out.println("Entered Standard Nickname successfully");
        } catch (Exception e) {
            System.out.println("Error while entering Standard Nickname: " + e.getMessage());
            Assert.fail("Entering Standard Nickname failed: " + e.getMessage());
        }
        ...
        try {
            WebElement Savebutton = wait.until(ExpectedConditions.elementToBeClickable(By.id("standardNicknameDetail.save")));
            Savebutton.click();
        ...
        try {
            ...
            inputElement.sendKeys("Name ");  // Press ENTER after "Rule Name"
            ...
            rulenameElement.sendKeys(Nickname1);  // Type the rule name
            ...
            File destDir = new File("C:\\Users\\mamatha.kp\\OneDrive - Subex Limited\\Documents\\Automation ss\\Standard_Nickname.png");
        ...
        try {
            ...
            okbutton.click();
            System.out.println("Nickname got deleted successfully");
        } catch (Exception e) {
        	System.out.println("failed while deleting Nickname");
        }
    }
}
