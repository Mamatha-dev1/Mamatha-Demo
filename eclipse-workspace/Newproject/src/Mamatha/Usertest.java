...
//            yesButton.click();
            ...
            WebElement commonTasks = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='gwt-HTML' and text()='Common Tasks']")));
        ...
        try {
            ...
            while (true) {
            	System.out.println("Please make sure that password should not contain 3 or more consecutive characters of username");
                ...
                if (isPasswordValid(password)) {
                    ...
                    System.out.println("Password should be at least 6 characters long and must contain unique characters.");
                }
            }
        ...
        try {
            ...
            WebElement rolesTab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='gwt-tabLabel' and text()='Roles And Partitions']")));
            rolesTab.click();

            WebElement checkbox = wait.until(ExpectedConditions.elementToBeClickable(By.id("CommoncheckBox_checked_column_field_image")));
...
//        }
        ...
        try
        {
            ...
            File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
       		File destDir = new File("C:\\Users\\mamatha.kp\\OneDrive - Subex Limited\\Documents\\Automation ss\\User.png");
    ...
    private void executeUsereandpasswordvalidation(WebDriver driver) throws InterruptedException {
        // Set timeout for the driver
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
...
Thread.sleep(3000);
    ...
    {
        File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
   		File destDir = new File("C:\\Users\\mamatha.kp\\OneDrive - Subex Limited\\Documents\\Automation ss\\Uservaidation.png");
   		FileUtils.copyFile(src, destDir);
    } catch (Exception e) {
    ...
    {
        File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
   		File destDir = new File("C:\\Users\\mamatha.kp\\OneDrive - Subex Limited\\Documents\\Automation ss\\passwordvalidation.png");
   		FileUtils.copyFile(src, destDir);
    } catch (Exception e) {
        System.out.println("Error while taking screenshot:" + e.getMessage());
