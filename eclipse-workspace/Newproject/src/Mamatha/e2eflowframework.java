...
public class e2eflowframework {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("userEmail")).sendKeys("mamatha.kp2017@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Gowda@678");
